      ...
      <html>
        <body style="font-family: Arial, sans-serif; color: #333;">
          <table style="max-width: 600px; margin: 0 auto; padding: 20px; background: #f9f9f9; border-radius: 8px;">
            <tr>
              <td>
                <h1 style="text-align: center; color: #4C6EB1;">Password Reset Request</h1>
                <p style="font-size: 16px;">Hello,</p>
                <p style="font-size: 16px;">We received a request to reset your password for your account. To reset your password, please click the button below:</p>
                <p style="text-align: center; margin-top: 20px;">
                  <a href="${resetUrl}" style="background-color: #4C6EB1; color: white; padding: 15px 30px; text-decoration: none; border-radius: 5px; font-size: 16px; font-weight: bold;">Reset Your Password</a>
                </p>
                <p style="font-size: 16px; margin-top: 20px;">If you did not request a password reset, please ignore this email. Your password will not be changed.</p>
                <p style="font-size: 16px;">Best regards,<br>Micrologic Data Marketplace</p>
                <p style="font-size: 12px; text-align: center; margin-top: 30px;">If you have any issues, please contact our support team at <a href="mailto:support@yourdomain.com">support@yourdomain.com</a>.</p>
              </td>
            </tr>
          </table>
        </body>
...
app.delete('/api/datasets/:id', authenticateToken, isAdmin, async (req, res) => {
  const { id } = req.params;
  try {
